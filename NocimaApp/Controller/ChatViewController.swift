...
class ChatViewController: JSQMessagesViewController  {
    ...
    override func viewDidLoad() {
        ...
        self.collectionView.contentInset = UIEdgeInsetsMake(240, -20, 0, -20)
        
        userThumb = UIImageView.init(frame: CGRectMake(0, 0, 80, 80))
        userThumb.center = CGPointMake(self.view.frame.size.width / 2 + 60, 180)
    ...
    func setupTitle(){
        ...
        self.titleView = UILabel(frame: CGRectMake((self.view.frame.size.width-titleWidth)/2, 20, titleWidth, 40))
